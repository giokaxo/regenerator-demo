...
import CustomersDataExportEmbedded from '../models/customers-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class CustomersDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): CustomersDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): CustomersDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | CustomersDataExportEmbedded | any) {
    if (value !== null && !(value instanceof CustomersDataExportEmbedded)) {
      value = new CustomersDataExportEmbedded(value);
    }
