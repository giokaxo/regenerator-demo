...
import PlaidAccountTokenPaymentInstrument from '../models/plaid-account-token-payment-instrument';
...
export default class PlaidAccountToken implements CompositeToken {
  ...
  get paymentInstrument(): PlaidAccountTokenPaymentInstrument {
    return this._fields['paymentInstrument'];
  }
  
  getPaymentInstrument(): PlaidAccountTokenPaymentInstrument {
      return this._fields['paymentInstrument'];
  }

  setPaymentInstrument(value: PlaidAccountTokenPaymentInstrument | any) {
    if (!(value instanceof PlaidAccountTokenPaymentInstrument)) {
      value = new PlaidAccountTokenPaymentInstrument(value);
    }
