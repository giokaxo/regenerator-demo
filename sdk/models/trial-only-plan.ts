...
export default class TrialOnlyPlan implements Plan, FlexiblePlan {
  get [Plan](): true {
    return true;
  }
  ...
  setTrial(value: PlanTrial | any) {
    if (!(value instanceof PlanTrial)) {
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'trial')) {
      data['trial'] = this['trial'].jsonSerialize();
    }
