...
export default class CreditMemoTimeline {
  TYPE_CREATED = 'credit-memo-created';

  TYPE_APPLIED = 'credit-memo-applied';

  TYPE_PARTIALLY_APPLIED = 'credit-memo-partially-applied';

  TYPE_VOIDED = 'credit-memo-voided';
