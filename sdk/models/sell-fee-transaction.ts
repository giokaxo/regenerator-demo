...
import SellFeeTransactionFee from '../models/sell-fee-transaction-fee';
import ResourceLink from '../models/resource-link';

export default class SellFeeTransaction implements BalanceTransaction {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'fee')) {
  ...
  get fee(): SellFeeTransactionFee | null {
    return this._fields['fee'] ?? null;
  }
  
  getFee(): SellFeeTransactionFee | null {
      return this._fields['fee'] ?? null;
  }

  setFee(value: null | SellFeeTransactionFee | any) {
    if (value !== null && !(value instanceof SellFeeTransactionFee)) {
      value = new SellFeeTransactionFee(value);
    }

    this._fields['fee'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'fee')) {
      data['fee'] = this['fee']?.jsonSerialize() ?? null;
    }
