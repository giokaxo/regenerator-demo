...
import KhelocardCardTokenPaymentInstrument from '../models/khelocard-card-token-payment-instrument';
...
export default class KhelocardCardToken implements CompositeToken {
  ...
  get paymentInstrument(): KhelocardCardTokenPaymentInstrument {
    return this._fields['paymentInstrument'];
  }
  
  getPaymentInstrument(): KhelocardCardTokenPaymentInstrument {
      return this._fields['paymentInstrument'];
  }

  setPaymentInstrument(value: KhelocardCardTokenPaymentInstrument | any) {
    if (!(value instanceof KhelocardCardTokenPaymentInstrument)) {
      value = new KhelocardCardTokenPaymentInstrument(value);
    }
