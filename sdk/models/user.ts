...
export default class User {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'computedPermissions')) {
  ...
  setBusinessPhone(value: null | string) {
  ...
  setMobilePhone(value: null | string) {
  ...
  get computedPermissions(): Array<any> | null {
    return this._fields['computedPermissions'] ?? null;
  }
  
  getComputedPermissions(): Array<any> | null {
      return this._fields['computedPermissions'] ?? null;
  }

  private setComputedPermissions(value: null | Array<any>) {
    this._fields['computedPermissions'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'computedPermissions')) {
      data['computedPermissions'] = this['computedPermissions'];
    }
