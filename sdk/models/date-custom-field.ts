...
import DateCustomFieldAdditionalSchema from '../models/date-custom-field-additional-schema';
import ResourceLink from '../models/resource-link';

export default class DateCustomField implements CustomField {
  ...
  get additionalSchema(): DateCustomFieldAdditionalSchema | null {
    return this._fields['additionalSchema'] ?? null;
  }
  
  getAdditionalSchema(): DateCustomFieldAdditionalSchema | null {
      return this._fields['additionalSchema'] ?? null;
  }

  setAdditionalSchema(value: null | DateCustomFieldAdditionalSchema | any) {
    if (value !== null && !(value instanceof DateCustomFieldAdditionalSchema)) {
      value = new DateCustomFieldAdditionalSchema(value);
    }
