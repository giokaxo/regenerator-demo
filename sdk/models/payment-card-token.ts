...
import PaymentCardTokenPaymentInstrument from '../models/payment-card-token-payment-instrument';
...
export default class PaymentCardToken implements CompositeToken {
  ...
  get paymentInstrument(): PaymentCardTokenPaymentInstrument {
    return this._fields['paymentInstrument'];
  }
  
  getPaymentInstrument(): PaymentCardTokenPaymentInstrument {
      return this._fields['paymentInstrument'];
  }

  setPaymentInstrument(value: PaymentCardTokenPaymentInstrument | any) {
    if (!(value instanceof PaymentCardTokenPaymentInstrument)) {
      value = new PaymentCardTokenPaymentInstrument(value);
    }
