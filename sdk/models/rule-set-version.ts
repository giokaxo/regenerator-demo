...
export default class RuleSetVersion {
  ...
  get rules(): Array<any> | null {
    return this._fields['rules'] ?? null;
  }
  
  getRules(): Array<any> | null {
      return this._fields['rules'] ?? null;
  }

  setRules(value: null | Array<any>) {
    value = value !== null ? value.map(
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'rules')) {
      data['rules'] = this['rules'] !== null
          ? this._fields['rules'].map((rule: Rule) => rule.jsonSerialize())
          : null;
    }
