...
import InvoicesDataExportEmbedded from '../models/invoices-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class InvoicesDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): InvoicesDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): InvoicesDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | InvoicesDataExportEmbedded | any) {
    if (value !== null && !(value instanceof InvoicesDataExportEmbedded)) {
      value = new InvoicesDataExportEmbedded(value);
    }
