...
import ProofOfIdentityKycDocumentDocumentMatches from '../models/proof-of-identity-kyc-document-document-matches';
import ProofOfIdentityKycDocumentParsedData from '../models/proof-of-identity-kyc-document-parsed-data';
import KycSettingsIdentity from '../models/kyc-settings-identity';
import ProofOfIdentityKycDocumentEmbedded from '../models/proof-of-identity-kyc-document-embedded';
import Tag from '../models/tag';
import ResourceLink from '../models/resource-link';

export default class ProofOfIdentityKycDocument implements KycDocument {
  ...
  get documentMatches(): ProofOfIdentityKycDocumentDocumentMatches | null {
    return this._fields['documentMatches'] ?? null;
  }
  
  getDocumentMatches(): ProofOfIdentityKycDocumentDocumentMatches | null {
      return this._fields['documentMatches'] ?? null;
  }

  setDocumentMatches(value: null | ProofOfIdentityKycDocumentDocumentMatches | any) {
    if (value !== null && !(value instanceof ProofOfIdentityKycDocumentDocumentMatches)) {
      value = new ProofOfIdentityKycDocumentDocumentMatches(value);
    }
  ...
  get parsedData(): ProofOfIdentityKycDocumentParsedData | null {
    return this._fields['parsedData'] ?? null;
  }
  
  getParsedData(): ProofOfIdentityKycDocumentParsedData | null {
      return this._fields['parsedData'] ?? null;
  }

  setParsedData(value: null | ProofOfIdentityKycDocumentParsedData | any) {
    if (value !== null && !(value instanceof ProofOfIdentityKycDocumentParsedData)) {
      value = new ProofOfIdentityKycDocumentParsedData(value);
    }
  ...
  get settings(): KycSettingsIdentity | null {
    return this._fields['settings'] ?? null;
  }
  
  getSettings(): KycSettingsIdentity | null {
      return this._fields['settings'] ?? null;
  }

  private setSettings(value: null | KycSettingsIdentity | any) {
  ...
  get embedded(): ProofOfIdentityKycDocumentEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): ProofOfIdentityKycDocumentEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | ProofOfIdentityKycDocumentEmbedded | any) {
    if (value !== null && !(value instanceof ProofOfIdentityKycDocumentEmbedded)) {
      value = new ProofOfIdentityKycDocumentEmbedded(value);
    }
