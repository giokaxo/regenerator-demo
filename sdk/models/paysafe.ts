import PaysafeCredentials from '../models/paysafe-credentials';
import ThreeDSecureIO3dsServer from '../models/three-d-secure-io-3-ds-server';
import GatewayAccount from '../models/gateway-account';

export default class Paysafe extends GatewayAccount {
  ...
  getCredentials(): PaysafeCredentials {
      return this._fields['credentials'];
  }

  setCredentials(value: PaysafeCredentials | any) {
    if (!(value instanceof PaysafeCredentials)) {
      value = new PaysafeCredentials(value);
    }
