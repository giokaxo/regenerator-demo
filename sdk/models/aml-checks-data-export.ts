...
import AmlChecksDataExportEmbedded from '../models/aml-checks-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class AmlChecksDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): AmlChecksDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): AmlChecksDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | AmlChecksDataExportEmbedded | any) {
    if (value !== null && !(value instanceof AmlChecksDataExportEmbedded)) {
      value = new AmlChecksDataExportEmbedded(value);
    }
