...
import ProofOfPurchaseKycDocumentDocumentMatches from '../models/proof-of-purchase-kyc-document-document-matches';
import ProofOfPurchaseKycDocumentParsedData from '../models/proof-of-purchase-kyc-document-parsed-data';
import ProofOfPurchaseKycDocumentEmbedded from '../models/proof-of-purchase-kyc-document-embedded';
import Tag from '../models/tag';
import ResourceLink from '../models/resource-link';

export default class ProofOfPurchaseKycDocument implements KycDocument {
  ...
  get documentMatches(): ProofOfPurchaseKycDocumentDocumentMatches | null {
    return this._fields['documentMatches'] ?? null;
  }
  
  getDocumentMatches(): ProofOfPurchaseKycDocumentDocumentMatches | null {
      return this._fields['documentMatches'] ?? null;
  }

  setDocumentMatches(value: null | ProofOfPurchaseKycDocumentDocumentMatches | any) {
    if (value !== null && !(value instanceof ProofOfPurchaseKycDocumentDocumentMatches)) {
      value = new ProofOfPurchaseKycDocumentDocumentMatches(value);
    }
  ...
  get parsedData(): ProofOfPurchaseKycDocumentParsedData | null {
    return this._fields['parsedData'] ?? null;
  }
  
  getParsedData(): ProofOfPurchaseKycDocumentParsedData | null {
      return this._fields['parsedData'] ?? null;
  }

  setParsedData(value: null | ProofOfPurchaseKycDocumentParsedData | any) {
    if (value !== null && !(value instanceof ProofOfPurchaseKycDocumentParsedData)) {
      value = new ProofOfPurchaseKycDocumentParsedData(value);
    }
  ...
  get embedded(): ProofOfPurchaseKycDocumentEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): ProofOfPurchaseKycDocumentEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | ProofOfPurchaseKycDocumentEmbedded | any) {
    if (value !== null && !(value instanceof ProofOfPurchaseKycDocumentEmbedded)) {
      value = new ProofOfPurchaseKycDocumentEmbedded(value);
    }
