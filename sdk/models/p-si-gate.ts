import PSiGateCredentials from '../models/p-si-gate-credentials';
import ThreeDSecureIO3dsServer from '../models/three-d-secure-io-3-ds-server';
import GatewayAccount from '../models/gateway-account';

export default class PSiGate extends GatewayAccount {
  ...
  get credentials(): PSiGateCredentials {
    return this._fields['credentials'];
  }
  
  getCredentials(): PSiGateCredentials {
      return this._fields['credentials'];
  }

  setCredentials(value: PSiGateCredentials | any) {
    if (!(value instanceof PSiGateCredentials)) {
      value = new PSiGateCredentials(value);
    }
