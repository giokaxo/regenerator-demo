...
import StringCustomFieldAdditionalSchema from '../models/string-custom-field-additional-schema';
import ResourceLink from '../models/resource-link';

export default class StringCustomField implements CustomField {
  ...
  get additionalSchema(): StringCustomFieldAdditionalSchema | null {
    return this._fields['additionalSchema'] ?? null;
  }
  
  getAdditionalSchema(): StringCustomFieldAdditionalSchema | null {
      return this._fields['additionalSchema'] ?? null;
  }

  setAdditionalSchema(value: null | StringCustomFieldAdditionalSchema | any) {
    if (value !== null && !(value instanceof StringCustomFieldAdditionalSchema)) {
      value = new StringCustomFieldAdditionalSchema(value);
    }
