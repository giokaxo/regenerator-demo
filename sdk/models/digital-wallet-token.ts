...
import DigitalWalletTokenPaymentInstrument from '../models/digital-wallet-token-payment-instrument';
...
export default class DigitalWalletToken implements CompositeToken {
  ...
  get paymentInstrument(): DigitalWalletTokenPaymentInstrument {
    return this._fields['paymentInstrument'];
  }
  
  getPaymentInstrument(): DigitalWalletTokenPaymentInstrument {
      return this._fields['paymentInstrument'];
  }

  setPaymentInstrument(value: DigitalWalletTokenPaymentInstrument | any) {
    if (!(value instanceof DigitalWalletTokenPaymentInstrument)) {
      value = new DigitalWalletTokenPaymentInstrument(value);
    }
  ...
  private setBillingAddress(value: null | ContactObject | any) {
