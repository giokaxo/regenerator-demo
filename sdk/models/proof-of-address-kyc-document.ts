...
import ProofOfAddressKycDocumentDocumentMatches from '../models/proof-of-address-kyc-document-document-matches';
import ProofOfAddressKycDocumentParsedData from '../models/proof-of-address-kyc-document-parsed-data';
import KycSettingsAddress from '../models/kyc-settings-address';
import ProofOfAddressKycDocumentEmbedded from '../models/proof-of-address-kyc-document-embedded';
import Tag from '../models/tag';
import ResourceLink from '../models/resource-link';

export default class ProofOfAddressKycDocument implements KycDocument {
  ...
  get documentMatches(): ProofOfAddressKycDocumentDocumentMatches | null {
    return this._fields['documentMatches'] ?? null;
  }
  
  getDocumentMatches(): ProofOfAddressKycDocumentDocumentMatches | null {
      return this._fields['documentMatches'] ?? null;
  }

  setDocumentMatches(value: null | ProofOfAddressKycDocumentDocumentMatches | any) {
    if (value !== null && !(value instanceof ProofOfAddressKycDocumentDocumentMatches)) {
      value = new ProofOfAddressKycDocumentDocumentMatches(value);
    }
  ...
  get parsedData(): ProofOfAddressKycDocumentParsedData | null {
    return this._fields['parsedData'] ?? null;
  }
  
  getParsedData(): ProofOfAddressKycDocumentParsedData | null {
      return this._fields['parsedData'] ?? null;
  }

  setParsedData(value: null | ProofOfAddressKycDocumentParsedData | any) {
    if (value !== null && !(value instanceof ProofOfAddressKycDocumentParsedData)) {
      value = new ProofOfAddressKycDocumentParsedData(value);
    }
  ...
  get settings(): KycSettingsAddress | null {
    return this._fields['settings'] ?? null;
  }
  
  getSettings(): KycSettingsAddress | null {
      return this._fields['settings'] ?? null;
  }

  private setSettings(value: null | KycSettingsAddress | any) {
  ...
  get embedded(): ProofOfAddressKycDocumentEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): ProofOfAddressKycDocumentEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | ProofOfAddressKycDocumentEmbedded | any) {
    if (value !== null && !(value instanceof ProofOfAddressKycDocumentEmbedded)) {
      value = new ProofOfAddressKycDocumentEmbedded(value);
    }
