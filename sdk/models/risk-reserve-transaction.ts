...
import RiskReserveTransactionRiskReserve from '../models/risk-reserve-transaction-risk-reserve';
import ResourceLink from '../models/resource-link';

export default class RiskReserveTransaction implements BalanceTransaction {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'riskReserve')) {
  ...
  get riskReserve(): RiskReserveTransactionRiskReserve | null {
    return this._fields['riskReserve'] ?? null;
  }
  
  getRiskReserve(): RiskReserveTransactionRiskReserve | null {
      return this._fields['riskReserve'] ?? null;
  }

  setRiskReserve(value: null | RiskReserveTransactionRiskReserve | any) {
    if (value !== null && !(value instanceof RiskReserveTransactionRiskReserve)) {
      value = new RiskReserveTransactionRiskReserve(value);
    }

    this._fields['riskReserve'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'riskReserve')) {
      data['riskReserve'] = this['riskReserve']?.jsonSerialize() ?? null;
    }
