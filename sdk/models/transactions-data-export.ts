...
import TransactionsDataExportEmbedded from '../models/transactions-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class TransactionsDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): TransactionsDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): TransactionsDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | TransactionsDataExportEmbedded | any) {
    if (value !== null && !(value instanceof TransactionsDataExportEmbedded)) {
      value = new TransactionsDataExportEmbedded(value);
    }
