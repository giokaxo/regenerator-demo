...
export default class SystemEvent {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'rulesCount')) {
      this.setRulesCount(data['rulesCount']);
    }
    if (Object.prototype.hasOwnProperty.call(data, 'bindsCount')) {
  ...
  get rulesCount(): number | null {
    return this._fields['rulesCount'] ?? null;
  }
  
  getRulesCount(): number | null {
      return this._fields['rulesCount'] ?? null;
  }

  private setRulesCount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }

    this._fields['rulesCount'] = value;

    return this;
  }

  get bindsCount(): number | null {
    return this._fields['bindsCount'] ?? null;
  }
  
  getBindsCount(): number | null {
      return this._fields['bindsCount'] ?? null;
  }

  private setBindsCount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }

    this._fields['bindsCount'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'rulesCount')) {
      data['rulesCount'] = this['rulesCount'];
    }
    if (Object.prototype.hasOwnProperty.call(this._fields, 'bindsCount')) {
      data['bindsCount'] = this['bindsCount'];
    }
