import AirwallexCredentials from '../models/airwallex-credentials';
import ThreeDSecureIO3dsServer from '../models/three-d-secure-io-3-ds-server';
import GatewayAccount from '../models/gateway-account';

export default class Airwallex extends GatewayAccount {
  ...
  get credentials(): AirwallexCredentials {
    return this._fields['credentials'];
  }
  
  getCredentials(): AirwallexCredentials {
      return this._fields['credentials'];
  }

  setCredentials(value: AirwallexCredentials | any) {
    if (!(value instanceof AirwallexCredentials)) {
      value = new AirwallexCredentials(value);
    }
