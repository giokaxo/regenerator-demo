...
import DateTimeCustomFieldAdditionalSchema from '../models/date-time-custom-field-additional-schema';
import ResourceLink from '../models/resource-link';

export default class DateTimeCustomField implements CustomField {
  ...
  get additionalSchema(): DateTimeCustomFieldAdditionalSchema | null {
    return this._fields['additionalSchema'] ?? null;
  }
  
  getAdditionalSchema(): DateTimeCustomFieldAdditionalSchema | null {
      return this._fields['additionalSchema'] ?? null;
  }

  setAdditionalSchema(value: null | DateTimeCustomFieldAdditionalSchema | any) {
    if (value !== null && !(value instanceof DateTimeCustomFieldAdditionalSchema)) {
      value = new DateTimeCustomFieldAdditionalSchema(value);
    }
