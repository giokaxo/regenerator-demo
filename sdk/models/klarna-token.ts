...
import KlarnaTokenPaymentInstrument from '../models/klarna-token-payment-instrument';
...
export default class KlarnaToken implements CompositeToken {
  ...
  get paymentInstrument(): KlarnaTokenPaymentInstrument {
    return this._fields['paymentInstrument'];
  }
  
  getPaymentInstrument(): KlarnaTokenPaymentInstrument {
      return this._fields['paymentInstrument'];
  }

  setPaymentInstrument(value: KlarnaTokenPaymentInstrument | any) {
    if (!(value instanceof KlarnaTokenPaymentInstrument)) {
      value = new KlarnaTokenPaymentInstrument(value);
    }
