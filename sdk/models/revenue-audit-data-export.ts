...
import RevenueAuditDataExportEmbedded from '../models/revenue-audit-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class RevenueAuditDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): RevenueAuditDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): RevenueAuditDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | RevenueAuditDataExportEmbedded | any) {
    if (value !== null && !(value instanceof RevenueAuditDataExportEmbedded)) {
      value = new RevenueAuditDataExportEmbedded(value);
    }
