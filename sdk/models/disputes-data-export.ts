...
import DisputesDataExportEmbedded from '../models/disputes-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class DisputesDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): DisputesDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): DisputesDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | DisputesDataExportEmbedded | any) {
    if (value !== null && !(value instanceof DisputesDataExportEmbedded)) {
      value = new DisputesDataExportEmbedded(value);
    }
