...
export default class PostmarkCredential implements ServiceCredential {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'serverApiToken')) {
  ...
  get serverApiToken(): string {
    return this._fields['serverApiToken'];
  }
  
  getServerApiToken(): string {
      return this._fields['serverApiToken'];
  }

  setServerApiToken(value: string) {
    this._fields['serverApiToken'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'serverApiToken')) {
      data['serverApiToken'] = this['serverApiToken'];
    }
