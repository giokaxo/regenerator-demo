import BroadcastMessageMessagesTemplates from '../models/broadcast-message-messages-templates';

export default class BroadcastMessageMessages {
  ...
  setTemplates(value: Array<any>) {
    value = value.map(
      (value) => value instanceof BroadcastMessageMessagesTemplates ? value : new BroadcastMessageMessagesTemplates(value),
    );
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'templates')) {
      data['templates'] = this['templates'].map(
          (broadcastMessageMessagesTemplates: BroadcastMessageMessagesTemplates) => broadcastMessageMessagesTemplates.jsonSerialize()
      );
    }
