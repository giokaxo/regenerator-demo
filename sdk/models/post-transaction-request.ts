...
export default class PostTransactionRequest {
  TYPE_SALE = 'sale';
  ...
  constructor(data: any = {}) {
    if (Object.prototype.hasOwnProperty.call(data, 'upsertCustomer')) {
  ...
  get upsertCustomer(): boolean | null {
    return this._fields['upsertCustomer'] ?? null;
  }
  
  getUpsertCustomer(): boolean | null {
      return this._fields['upsertCustomer'] ?? null;
  }

  setUpsertCustomer(value: null | boolean) {
    this._fields['upsertCustomer'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'upsertCustomer')) {
      data['upsertCustomer'] = this['upsertCustomer'];
    }
