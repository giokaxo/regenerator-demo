...
import QuoteCreateOrderItemsUsageLimits from '../models/quote-create-order-items-usage-limits';
import QuoteCreateOrderItemsEmbedded from '../models/quote-create-order-items-embedded';

export default class QuoteCreateOrderItems {
  ...
  get usageLimits(): QuoteCreateOrderItemsUsageLimits | null {
    return this._fields['usageLimits'] ?? null;
  }
  
  getUsageLimits(): QuoteCreateOrderItemsUsageLimits | null {
      return this._fields['usageLimits'] ?? null;
  }

  setUsageLimits(value: null | QuoteCreateOrderItemsUsageLimits | any) {
    if (value !== null && !(value instanceof QuoteCreateOrderItemsUsageLimits)) {
      value = new QuoteCreateOrderItemsUsageLimits(value);
    }
  ...
  get embedded(): QuoteCreateOrderItemsEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): QuoteCreateOrderItemsEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | QuoteCreateOrderItemsEmbedded | any) {
    if (value !== null && !(value instanceof QuoteCreateOrderItemsEmbedded)) {
      value = new QuoteCreateOrderItemsEmbedded(value);
    }
