...
import KhelocardCardEmbedded from '../models/khelocard-card-embedded';
import ResourceLink from '../models/resource-link';

export default class KhelocardCard implements PaymentInstrument {
  ...
  get embedded(): KhelocardCardEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): KhelocardCardEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | KhelocardCardEmbedded | any) {
    if (value !== null && !(value instanceof KhelocardCardEmbedded)) {
      value = new KhelocardCardEmbedded(value);
    }
