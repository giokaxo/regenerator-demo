...
export default class JournalEntryPeriod {
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'startDate')) {
      data['startDate'] = this['startDate']?.toISOString().substring(0, 10) ?? null;
    }
    if (Object.prototype.hasOwnProperty.call(this._fields, 'endDate')) {
      data['endDate'] = this['endDate']?.toISOString().substring(0, 10) ?? null;
    }
