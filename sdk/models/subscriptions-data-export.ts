...
import SubscriptionsDataExportEmbedded from '../models/subscriptions-data-export-embedded';
import ResourceLink from '../models/resource-link';

export default class SubscriptionsDataExport implements DataExport {
  get [DataExport](): true {
    return true;
  }
  ...
  get embedded(): SubscriptionsDataExportEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): SubscriptionsDataExportEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | SubscriptionsDataExportEmbedded | any) {
    if (value !== null && !(value instanceof SubscriptionsDataExportEmbedded)) {
      value = new SubscriptionsDataExportEmbedded(value);
    }
