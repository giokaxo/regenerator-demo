...
import QuoteChangeOrderItemsUsageLimits from '../models/quote-change-order-items-usage-limits';
import QuoteChangeOrderItemsEmbedded from '../models/quote-change-order-items-embedded';

export default class QuoteChangeOrderItems {
  ...
  get usageLimits(): QuoteChangeOrderItemsUsageLimits | null {
    return this._fields['usageLimits'] ?? null;
  }
  
  getUsageLimits(): QuoteChangeOrderItemsUsageLimits | null {
      return this._fields['usageLimits'] ?? null;
  }

  setUsageLimits(value: null | QuoteChangeOrderItemsUsageLimits | any) {
    if (value !== null && !(value instanceof QuoteChangeOrderItemsUsageLimits)) {
      value = new QuoteChangeOrderItemsUsageLimits(value);
    }
  ...
  get embedded(): QuoteChangeOrderItemsEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): QuoteChangeOrderItemsEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | QuoteChangeOrderItemsEmbedded | any) {
    if (value !== null && !(value instanceof QuoteChangeOrderItemsEmbedded)) {
      value = new QuoteChangeOrderItemsEmbedded(value);
    }
