...
import BuyFeeTransactionFee from '../models/buy-fee-transaction-fee';
import ResourceLink from '../models/resource-link';

export default class BuyFeeTransaction implements BalanceTransaction {
  ...
  get fee(): BuyFeeTransactionFee | null {
    return this._fields['fee'] ?? null;
  }
  
  getFee(): BuyFeeTransactionFee | null {
      return this._fields['fee'] ?? null;
  }

  setFee(value: null | BuyFeeTransactionFee | any) {
    if (value !== null && !(value instanceof BuyFeeTransactionFee)) {
      value = new BuyFeeTransactionFee(value);
    }
