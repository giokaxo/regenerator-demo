...
import ArrayCustomFieldAdditionalSchema from '../models/array-custom-field-additional-schema';
import ResourceLink from '../models/resource-link';

export default class ArrayCustomField implements CustomField {
  ...
  get additionalSchema(): ArrayCustomFieldAdditionalSchema | null {
    return this._fields['additionalSchema'] ?? null;
  }
  
  getAdditionalSchema(): ArrayCustomFieldAdditionalSchema | null {
      return this._fields['additionalSchema'] ?? null;
  }

  setAdditionalSchema(value: null | ArrayCustomFieldAdditionalSchema | any) {
    if (value !== null && !(value instanceof ArrayCustomFieldAdditionalSchema)) {
      value = new ArrayCustomFieldAdditionalSchema(value);
    }
