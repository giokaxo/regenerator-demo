...
import IntegerCustomFieldAdditionalSchema from '../models/integer-custom-field-additional-schema';
import ResourceLink from '../models/resource-link';

export default class IntegerCustomField implements CustomField {
  ...
  get additionalSchema(): IntegerCustomFieldAdditionalSchema | null {
    return this._fields['additionalSchema'] ?? null;
  }
  
  getAdditionalSchema(): IntegerCustomFieldAdditionalSchema | null {
      return this._fields['additionalSchema'] ?? null;
  }

  setAdditionalSchema(value: null | IntegerCustomFieldAdditionalSchema | any) {
    if (value !== null && !(value instanceof IntegerCustomFieldAdditionalSchema)) {
      value = new IntegerCustomFieldAdditionalSchema(value);
    }
