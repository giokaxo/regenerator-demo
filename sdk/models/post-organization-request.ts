...
export default class PostOrganizationRequest {
  ...
  get reportCurrency(): string {
    return this._fields['reportCurrency'];
  }
  ...
  setReportCurrency(value: string) {
