...
import ProofOfCreditFileKycDocumentDocumentMatches from '../models/proof-of-credit-file-kyc-document-document-matches';
import ProofOfCreditFileKycDocumentEmbedded from '../models/proof-of-credit-file-kyc-document-embedded';
import Tag from '../models/tag';
import ResourceLink from '../models/resource-link';

export default class ProofOfCreditFileKycDocument implements KycDocument {
  ...
  get documentMatches(): ProofOfCreditFileKycDocumentDocumentMatches | null {
    return this._fields['documentMatches'] ?? null;
  }
  
  getDocumentMatches(): ProofOfCreditFileKycDocumentDocumentMatches | null {
      return this._fields['documentMatches'] ?? null;
  }

  setDocumentMatches(value: null | ProofOfCreditFileKycDocumentDocumentMatches | any) {
    if (value !== null && !(value instanceof ProofOfCreditFileKycDocumentDocumentMatches)) {
      value = new ProofOfCreditFileKycDocumentDocumentMatches(value);
    }
  ...
  get embedded(): ProofOfCreditFileKycDocumentEmbedded | null {
    return this._fields['_embedded'] ?? null;
  }
  
  getEmbedded(): ProofOfCreditFileKycDocumentEmbedded | null {
      return this._fields['_embedded'] ?? null;
  }

  setEmbedded(value: null | ProofOfCreditFileKycDocumentEmbedded | any) {
    if (value !== null && !(value instanceof ProofOfCreditFileKycDocumentEmbedded)) {
      value = new ProofOfCreditFileKycDocumentEmbedded(value);
    }
