...
export default class Rule {
  ...
  get final(): boolean | null {
    return this._fields['final'] ?? null;
  }
  
  getFinal(): boolean | null {
      return this._fields['final'] ?? null;
  }

  setFinal(value: null | boolean) {
    this._fields['final'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'final')) {
