...
export default class AmlSettingsConfidenceNoDob {
  ...
  constructor(data: any = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, 'weakMatch')) {
  ...
  get weakMatch(): AmlCompoundConfidence | null {
    return this._fields['weakMatch'] ?? null;
  }
  
  getWeakMatch(): AmlCompoundConfidence | null {
      return this._fields['weakMatch'] ?? null;
  }

  setWeakMatch(value: null | AmlCompoundConfidence | any) {
    if (value !== null && !(value instanceof AmlCompoundConfidence)) {
      value = new AmlCompoundConfidence(value);
    }

    this._fields['weakMatch'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'weakMatch')) {
      data['weakMatch'] = this['weakMatch']?.jsonSerialize() ?? null;
    }
