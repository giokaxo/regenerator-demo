...
export default class AdyenCredentials {
  protected _fields: Record<string, any> = {};

  constructor(data: any = {}) {
    if (Object.prototype.hasOwnProperty.call(data, 'merchantAccount')) {
  ...
  get merchantAccount(): string {
    return this._fields['merchantAccount'];
  }
  ...
  setMerchantAccount(value: string) {
    this._fields['merchantAccount'] = value;
  ...
  jsonSerialize(): Record<string, any> {
    ...
    if (Object.prototype.hasOwnProperty.call(this._fields, 'merchantAccount')) {
