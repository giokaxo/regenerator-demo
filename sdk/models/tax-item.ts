import TaxItemJurisdictions from '../models/tax-item-jurisdictions';

export default class TaxItem {
  ...
  private setRate(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setStateAmount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setCountyAmount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setCityAmount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setSpecialDistrictAmount(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setStateRate(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setCountyRate(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setCityRate(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  private setSpecialDistrictRate(value: null | number | string) {
    if (typeof value === 'string') {
      value = Number(value);
    }
  ...
  get jurisdictions(): TaxItemJurisdictions | null {
    return this._fields['jurisdictions'] ?? null;
  }
  
  getJurisdictions(): TaxItemJurisdictions | null {
      return this._fields['jurisdictions'] ?? null;
  }

  setJurisdictions(value: null | TaxItemJurisdictions | any) {
    if (value !== null && !(value instanceof TaxItemJurisdictions)) {
      value = new TaxItemJurisdictions(value);
    }
