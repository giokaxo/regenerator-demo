import PayComCredentials from '../models/pay-com-credentials';
import ThreeDSecureIO3dsServer from '../models/three-d-secure-io-3-ds-server';
import GatewayAccount from '../models/gateway-account';

export default class PayCom extends GatewayAccount {
  ...
  get credentials(): PayComCredentials {
    return this._fields['credentials'];
  }
  
  getCredentials(): PayComCredentials {
      return this._fields['credentials'];
  }

  setCredentials(value: PayComCredentials | any) {
    if (!(value instanceof PayComCredentials)) {
      value = new PayComCredentials(value);
    }
